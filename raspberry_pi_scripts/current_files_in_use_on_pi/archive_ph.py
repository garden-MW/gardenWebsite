...
FILENAME = '/home/hydro/raspberry_pi_scripts/ph_data/ph_data_archive.json'
FILES_TO_CLEAR_CRON =  ["/home/hydro/raspberry_pi_scripts/ph_data/cron_log.txt" , "/home/hydro/raspberry_pi_scripts/ph_data/cron_log2.txt"]
ARCHIVE_FOLDER = '/home/hydro/raspberry_pi_scripts/ph_data/archives/'
...
if old_data:
    ...
    archive_json_name = f'ph_archive_{timestamp_now}.json'
    ...
    # Now compress it
    archive_zip_name = f'ph_archive_{timestamp_now}.zip'
