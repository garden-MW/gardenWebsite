...
import BlankData3 from '../../../../models/PH'; //will need to update models, seed data, next, etc. 
...
export async function GET(request){
    ...
    try {
      ...
      return NextResponse.json({
        error: "Failed to fetch blankData3 data",
...
export async function PUT(request){
    try {
        ...
        const blankData3 = await BlankData3.query().insertAndFetch(dataPoints);
        return NextResponse.json(blankData3);
    } catch (error) {
