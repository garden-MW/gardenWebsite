...
import BlankData1 from '../../../../models/PH'; //will need to update models, seed data, next, etc. 
...
export async function GET(request){
    ...
    try {
      ...
      return NextResponse.json({
        error: "Failed to fetch blankData1 data",
...
export async function PUT(request){
    try {
        ...
        const blankData1 = await BlankData1.query().insertAndFetch(dataPoints);
        return NextResponse.json(blankData1);
    } catch (error) {
